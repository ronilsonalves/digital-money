...
public class TransactionsVisualizationTest {

    @Test
    @Tag("Sprint 2")
    public void CorrectAccountId_shouldReturnCode200AndDetailedTransactionData() {
        ...
        response = request2.get("/api/accounts/" + account_id + "/transactions");
